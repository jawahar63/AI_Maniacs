...
<?php include 'header.php'?>
		...
		<div id="home" class="hero-area">
			...
			<!-- Backgound Image -->
			<div class="bg-image overlay" style="background-image:url(./img/bg22.jpg); width:100%; height: 656px; background-attachment: fixed;"></div>
			<!-- /Backgound Image -->
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							...
							<h1 class="white-text" style="font-size: 24px;margin-top: 20px;
							margin-bottom:40px;">Confused What Career You Fit into the Most?<br><b>AI MANIACS is the right Destination!</b></h1>
							...
							<?php
								...
								<?php else: ?>
									<p class="lead white-text" style="margin-left: 5px;" ><b>Hi, <?php echo htmlspecialchars($_SESSION["username"]); ?> !<br><b>Discover yourself,</p>

									<a class="main-button icon-button" href="http://127.0.0.1:5000/">After Engineering</a>
									<a class="main-button icon-button" href="10th.php">For 10th grade</a>
									<a class="main-button icon-button" href="12th.php">For 12th grade</a>
							<?php endif ?>
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome to AI MANIACS</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">AI MANIACS</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="section-header">
							<h2 style="font-size: 35px;">About AI MANIACS</h2>
